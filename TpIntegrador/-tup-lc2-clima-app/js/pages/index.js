...
formcitylist.addEventListener('submit',(e)=>{
    ...
    fetch(url)
        ...
        .then (data =>{
            console.log(data);
            sectionweatherresult.innerHTML= `<div class="card"><h3>${ciudad}</h3> <img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png"><p>Temperatura: ${data.main.temp}º</p><p>Sensación Térmica: ${data.main.feels_like}º</p><p>Humedad: ${data.main.humidity}%</p><p>Velocidad de viento: ${data.main.pressure}km/h</p><p>Presión: ${data.wind.speed} P</p></div>`
        })
})
